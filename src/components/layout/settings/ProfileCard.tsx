    ...
    return(
        ...
        <div className="flex flex-col justify-center items-center w-[300px] h-full">
            <div className="h-[65%] w-[300px] flex items-center justify-center">
                <Image className="mb-3 rounded-full h-24 w-24 p-1 bg-white" src="https://assets.moxfield.net/profile/profile-5994-81598eaa-48df-40f2-ac4b-b5fce005dd7e" alt="profile-icon" />
            </div>
