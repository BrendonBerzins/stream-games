    ...
    <section className="flex items-center"> 
        <aside className="h-screen w-[35vh] overflow-hidden transition-sidebar">
            ...
            <Link onClick={() => setShowSidebar(false)} href={'/friends'} className="flex gap-2">
                <img className="rounded-full h-8 w-8 cursor-pointer" src="https://p2.trrsf.com/image/fget/cf/600/600/images.terra.com/2022/10/03/overwatch-2-cover-qhsw1srgxh6h.png" alt="profile-icon" />
                <img className="rounded-full h-8 w-8 cursor-pointer" src="https://i.pinimg.com/280x280_RS/eb/f2/aa/ebf2aafd74920b9f15b605476814ec7f.jpg" alt="profile-icon" />
                <img className="rounded-full h-8 w-8 cursor-pointer" src="https://avatarfiles.alphacoders.com/916/91642.jpg" alt="profile-icon" />
                <img className="rounded-full h-8 w-8 cursor-pointer" src="https://i.pinimg.com/736x/1a/8c/5a/1a8c5adb2405a2e9d4172e8c97d62cc3.jpg" alt="profile-icon" />
            </Link>
            </div>
            </nav>
        </aside>
